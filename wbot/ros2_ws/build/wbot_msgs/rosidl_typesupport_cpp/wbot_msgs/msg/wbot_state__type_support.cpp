...
static const _WbotState_type_support_symbol_names_t _WbotState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wbot_msgs, msg, WbotState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wbot_msgs, msg, WbotState)),
  }
};
...
{
  return &::wbot_msgs::msg::rosidl_typesupport_cpp::WbotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wbot_msgs, msg, WbotState)() {
  return get_message_type_support_handle<wbot_msgs::msg::WbotState>();
}
