...
bool wbot_msgs__msg__wbot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wbot_msgs.msg._wbot_state.WbotState", full_classname_dest, 35) == 0);
  }
  wbot_msgs__msg__WbotState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of WbotState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wbot_msgs.msg._wbot_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WbotState");
